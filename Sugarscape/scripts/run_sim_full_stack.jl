...
adata = if architecture == "bigfive"
    ...
    [
        ...
        :culture, :children, :loans_given, :loans_owed, :has_reproduced, :total_inheritance_received,
        :last_partner_id, :last_credit_partner, :last_combat_partner, :chose_not_to_attack, :chose_not_to_borrow, :chose_not_to_lend, :chose_not_to_reproduce, :chose_not_to_spread_culture, :traits
    ]
elseif architecture == "schwartz"
    ...
    [
        :pos, :sugar, :age, :vision, :metabolism, :sex,
        :culture, :children, :loans_given, :loans_owed, :has_reproduced, :total_inheritance_received,
        :last_partner_id, :last_credit_partner, :last_combat_partner, :chose_not_to_attack, :chose_not_to_borrow, :chose_not_to_lend, :chose_not_to_reproduce, :chose_not_to_spread_culture, :schwartz_values
    ]
else
